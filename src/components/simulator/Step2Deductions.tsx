    ...
    <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
      ...
      <Card className="skandia-card space-y-6 mb-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground">Cuentan: hijos hasta 23 años que estudien, hijos con discapacidad, cónyuge o compañero sin ingresos o con ingresos menores a 260 UVT ($13.617.240), padres o hermanos que dependan de ti. Máximo 4.</p>
        </div>
      ...
      <Card className="skandia-card space-y-6 mb-6">
        ...
        {formData.hasHip && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-4">
            <CurrencyInput
              label="¿Cuánto pagaste en intereses durante el 2026? (total del año)"
