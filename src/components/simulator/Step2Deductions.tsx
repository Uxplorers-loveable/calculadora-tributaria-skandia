...
const Step2Deductions = ({ formData, setFormData, onNext, onBack }: Step2Props) => {
  ...
  return (
    <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.3 }}>
      <Card data-sami-key="ded_dependents" className="skandia-card space-y-6 mb-6">
      ...
      <Card data-sami-key="ded_housing" className="skandia-card space-y-6 mb-6">
      ...
      <Card data-sami-key="ded_health" className="skandia-card space-y-6 mb-6">
        <div className="flex items-center justify-between">
      ...
      <Card data-sami-key="ded_invoice" className="mb-6 p-8 rounded-lg border-t-4 border-t-success border border-border space-y-6">
        ...
        {formData.comprasFE > 0 && (
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="p-4 rounded-lg border bg-skandia-gold-light border-skandia-gold-border">
              <p className="text-xs font-medium uppercase tracking-wider mb-1 text-foreground">Escenario 5%</p>
